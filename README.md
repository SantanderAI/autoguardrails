...
> An autoresearch-style guardrail loop that searches over a single mutable `policy.md` surface — minimizing attack success rate (ASR) against a fixed evaluation suite, with a benign-pass floor.
